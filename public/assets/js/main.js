...
$(function () {
    ...
    /*==========   Mobile Menu   ==========*/
    var $navToggler1 = $('#toggle-first.navbar-toggler');
    $navToggler1.on('click', function () {
        $(this).toggleClass('actived');
    })
    $navToggler1.on('click', function () {
        $('#mainNavigation.navbar-collapse').toggleClass('menu-opened');
    })

    var $navToggler2 = $('#toggle-second.navbar-toggler');
